...
# CODUL TĂU VINE MAI JOS:
def task_11(numere):
    return max(numere) if numere else None
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
def task_20(numar):
    return numar > 1 and numar == sum(i for i in range(1, numar) if numar % i == 0)
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
def task_21(numar):
    suma = sum(int(cifra) ** len(str(numar)) for cifra in str(numar))
    return numar == suma
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
def task_22(numar):
    return numar > 0 and numar % sum(int(cifra) for cifra in str(numar)) == 0
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
def task_24(numar):
    return [i for i in range(1, numar + 1) if numar % i == 0]
# CODUL TĂU VINE MAI SUS:
